...
#
#       analysis/multi_fishery_trip_summary.R      (effort + trips)
#       analysis/multi_fishery_harvest_summary.R   (harvest)
#
...
#
# Usage:
#   Rscript analysis/multi_fishery_creel_summary.R
...
process_fishery <- function(fishery_name, period_pe = PERIOD_PE) {
  ...
  if (nrow(multi_area) > 0) {
    cli::cli_alert_warning(
      "  Section{?s} {.val {multi_area$section_num}} map to >1 crc_area; \\
