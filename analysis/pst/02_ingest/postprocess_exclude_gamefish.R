...
#   full pipeline. Reloads the saved .rds outputs, drops any gamefish-primary
#   fishery_name rows, and overwrites both the .rds and .csv files in place.
#
# Usage:
...
targets <- tibble::tribble(
  ...
  "effort_index_fail_counts",  "multi_fishery_creel_effort_index_fail_counts",
  "stability_combined",        "multi_fishery_creel_trip_length_stability"
)
