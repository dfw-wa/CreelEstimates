...
if (!is.null(deliverable_trips)) {
  ...
  note <- c(
    ...
    glue("- Location assumed bank only (no data available to assign trips to boat location): {share(dt$`Location Basis` == 'Assumed bank only (no data available to assign trips to boat location)')}% of all trips."),
    "",
